        ...
        <AnimatedSection delay={200}>
          ...
          >
            <CarouselContent className="-ml-1">
              {logos.map((logo) => (
                <CarouselItem key={logo.id} className="pl-4 md:basis-1/3 lg:basis-1/5">
                  <div className="p-1">
                    <div className="overflow-hidden rounded-lg bg-white border border-gray-200 flex items-center justify-center h-24 p-4">
                      <img 
                        src={logo.url} 
                        alt={`${logo.name} logo`} 
