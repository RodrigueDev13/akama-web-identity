        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <ServiceCard
              ...
              description="Solutions informatiques, maintenance, réseaux, sécurité et développement web pour optimiser votre infrastructure."
            ...
            <ServiceCard
              title="Imprimerie"
              description="Services d'impression professionnels : tampons, photocopies, impressions variées pour tous vos documents."
            ...
            <ServiceCard
              title="Formation"
              description="Formations spécialisées en réseaux, maintenance, logiciels et design graphique pour développer vos compétences."
            ...
            <ServiceCard
              ...
              description="Création de contenu audiovisuel de qualité pour vos besoins professionnels et marketing."
              icon={<Video size={24} />}
              delay={400}
            />
            ...
            <ServiceCard
              ...
              description="Audits, consultations et recommandations stratégiques pour optimiser vos processus et technologies."
            ...
            <ServiceCard
              ...
              description="Services variés incluant bâtiment, location/vente de voitures et autres solutions sur mesure."
              icon={<Users size={24} />}
              delay={600}
            />
          </div>
